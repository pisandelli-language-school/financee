...
const referenceDate = computed(() => {
  ...
  const end = new Date(`${selectedRange.value.end}T00:00:00.000Z`)
...
watch(() => [reportsStore.filters.dateFrom, reportsStore.filters.dateTo] as const, async (current, previous) => {
